...
public static void runIntegerStackTest(){
		...
		while (true) {
			...
			System.out.println("1 -- Yýðýta bir tamsayý ekle");
			System.out.println("2 -- Yýðýtýn üstündeki öðeyi sil");
			System.out.println("3 -- Yýðýtý yazdýr");
			...
			if (input == 1) {
				...
				System.out.println("Öðe: \"" + integerStack.pop() + "\" Yýðýtýn üstünden alýndý");
			} else if (input == 3) {
